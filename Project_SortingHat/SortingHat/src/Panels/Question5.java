...
public class Question5 extends javax.swing.JFrame {
    ...
    public Question5(int totalScore){
        initComponents();
        temp = totalScore;
    }
    ...
    private void initComponents() {
        ...
        lblHeader.setText("Q5. You find an injured bird, you...");
        ...
        btnGroup5.add(btnRadio1);
        btnRadio1.setText("Leave it, survival of the fittest");
        ...
        btnGroup5.add(btnRadio2);
        btnRadio2.setText("Want to help, but what if it has a disease? NO THANKS");
        ...
        btnGroup5.add(btnRadio3);
        btnRadio3.setText("Take it home, or to someone who can help it");
        ...
        btnGroup5.add(btnRadio4);
        btnRadio4.setText("Leave some food and hope for the best");
    ...
    private void btnRadio1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRadio1ActionPerformed
        ...
        Question6 q6 = new Question6(total);
        q6.setVisible(true);
